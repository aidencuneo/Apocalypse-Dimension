...
public class mcreator_mushroomSnack {

	public mcreator_mushroomSnack() {
	}
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT)
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("testenvironmentmod:mushroomsnack", "inventory"));
	}
	...
	public static class CustomItemFood extends ItemFood {
		public CustomItemFood(int par2, float par3, boolean par4) {
			...
			setUnlocalizedName("MushroomSnack");
			setRegistryName("MushroomSnack");
